...
# live agent turn. Concurrent duplicates reuse the owning call's real result.
...
# local CLI's ``voice_delivery`` toolset. Messaging platforms such as Feishu do
# not include this toolset and retain their normal response behavior.
registry.register(
    name="send_message",
