# Recording end phrase: Over and out
...
qualifies as quiet; louder noise and distant/quiet speech need room testing.
...
memory, reused across turns, plus a bounded worker while recording. Stop/cancel
