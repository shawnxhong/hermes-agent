...
Date: 2026-09-09. Status: incident resolved by the general voice workflow
release; upgrade cancelled by user.
...
See `VOICE_GENERALIZATION_RELEASE.md` for the implemented boundaries and
